        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12 mt-3">
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-header text-white" style="background: url('./images/user-bg.png') center center;">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-pane" id="settings">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea v-model="form.bio" class="form-control" id="bio" placeholder="Short User Bio"></textarea>
                        ...
                        <div class="form-group">
                            <label for="password" class="col-sm-12 control-label">Passport</label>
                            <div class="col-sm-12">
